...
`;
    ...
    <Box>
      <Box display='flex' sx={{background:'linear-gradient(to right, #0f5c33, #034220)'}} width='100%' height="7vh" justifyContent='center' alignItems='center' >
        ...
        }} textAlign='center' >Center for Advanced Urology and kidney Diseases is the only center in the entire North Eastern region of India dedicated only for Urological problems.</Typography>
      </Box>
    </Box>
    </>)
}